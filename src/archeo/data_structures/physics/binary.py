...
class BinaryGenerator(BaseModel, frozen=True):
    ...
    def draw(self, size: int = 1) -> list[Binary]:
        ...
        while len(binaries) < size:
            ...
            n_step += 1
            local_logger.info("Step %d: Generated %d binaries so far.", n_step, len(binaries))
        ...
        if self.is_aligned_spin:
            ...
            local_logger.info("Applied aligned spin configuration to the generated binaries.")
