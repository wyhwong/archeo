...
def simulate_second_generation_precession_spin_binaries(size: int = 2000000, n_workers: Optional[int] = None):
...
def simulate_second_generation_aligned_spin_binaries(size: int = 2000000, n_workers: Optional[int] = None):
